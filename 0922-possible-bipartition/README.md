<h2><a href="https://leetcode.com/problems/possible-bipartition/?envType=problem-list-v2&envId=depth-first-search">922. Possible Bipartition</a></h2><h3>Medium</h3><hr><p>We want to split a group of <code>n</code> people (labeled from <code>1</code> to <code>n</code>) into two groups of <strong>any size</strong>. Each person may dislike some other people, and they should not go into the same group.</p>
