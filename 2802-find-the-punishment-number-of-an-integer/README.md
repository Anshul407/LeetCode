<h2><a href="https://leetcode.com/problems/find-the-punishment-number-of-an-integer/?envType=problem-list-v2&envId=backtracking">2802. Find the Punishment Number of an Integer</a></h2><h3>Medium</h3><hr><p>Given a positive integer <code>n</code>, return <em>the <strong>punishment number</strong></em> of <code>n</code>.</p>
